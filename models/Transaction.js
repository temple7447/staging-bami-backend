...
const TransactionSchema = new mongoose.Schema({
  ...
  type: { type: String, enum: ['rent', 'utility', 'deposit', 'withdrawal', 'service_charge', 'security_charge', 'caution_fee', 'legal_fee', 'maintenance', 'initial', 'bundle', 'other'], required: true },
